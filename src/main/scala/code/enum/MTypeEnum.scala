...
object MTypeEnum extends Enumeration {
  ...
  val ACTION_FIGHTER_STRIKE      = Value("AFH1")
  val ACTION_FIGHTER_STRIKE2     = Value("AFH2")
  val ACTION_ARSIS               = Value("AAR1")
  val ACTION_SHAHEARTACK         = Value("ASH1") 
  val ACTION_HUNSOULACK          = Value("AHS1")
  val ACTION_HUNSOULLOWER        = Value("AHS2")
  val ACTION_JUDGMENTACK         = Value("AJM1") 
  ...
  val ACTION_AICHA_GRASP         = Value("AAG1")
  val ACTION_CLACKEN_CAPTURE     = Value("ACC1")
