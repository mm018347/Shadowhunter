...
object MTypeEnum extends Enumeration {
  ...
  val RESULT_DRAGON               = Value("RD")
  val RESULT_LOCROB               = Value("RL")
  ...
  val ACTION_CARDCHOOSE2          = Value("AC2")
  val ACTION_ITEMPREFERRED        = Value("AI")
  val ACTION_WISHING              = Value("AW")
  ...
  val ACTION_MICAH_CONFUSED       = Value("AMC1")
  val ACTION_MICAH_CONFUSED2      = Value("AMC2")
  val ACTION_AICHA_GRASP          = Value("AAG1")
  val ACTION_CLACKEN_CAPTURE      = Value("ACC1")
  val ACTION_SETH_CONTROL         = Value("ASC1")
  val ACTION_SETH_CONTROL2        = Value("ASC2")
  val ACTION_LEON_CHARGES         = Value("ALE1")
  val ACTION_LEON_CHARGES2        = Value("ALE2")
  val ACTION_LEON_USE             = Value("ALE3")
  val ACTION_AMETSUKI_CURSE       = Value("AAC1")
  val ACTION_PUZZLE_SPIKE         = Value("APS1")
  val ACTION_GINGER_RESENTFUL     = Value("AGS1")
  val ACTION_WESTLOBE_PRY         = Value("AWP1")
  val ACTION_TEL_WATERMIRROR      = Value("ATM1")
  val ACTION_LUBE_RESPONSE        = Value("ALB1")
